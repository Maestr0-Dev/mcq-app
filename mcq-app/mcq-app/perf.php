...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_quiz'])) {
    ...
    // Add the quiz using the Quiz class
    $quizClass->addQuiz($title, $creator, $questions);
}

// Fetch all quizzes created by others
...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <textarea name="questions[]" placeholder="Enter questions (one per line)" required></textarea>
